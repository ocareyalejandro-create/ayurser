# The Ayurser Book — our own source of truth

This is the canon the whole app draws from. The engine, the feeling-map, and the
Wisdom section are all *windows into these pages* — not the truth itself, only
doorways onto it.

It is authored in **one voice** — quiet and reverent — and written **by us**: we
